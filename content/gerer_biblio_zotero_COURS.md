...
- [8. Conclusion](#8-conclusion)
   ...
   - [Aller plus loin](#aller-plus-loin)
      ...
      - [Ajouter des moteurs de recherche intégrés à Zotero](#ajouter-des-moteurs-de-recherche-intégrés-à-zotero)
...
![icone_zotero](img/icone_zotero.png) [Documentation Zotero : Installation](https://www.zotero.org/support/fr/installation)

![icone_zotero](img/icone_zotero.png) [Documentation Zotero : Préférences](https://www.zotero.org/support/fr/preferences)
...
### Ressources
![icone_zotero](img/icone_zotero.png) [Documentation Zotero : Ajouter des documents à Zotero](https://www.zotero.org/support/fr/adding_items_to_zotero)

![icone_zotero](img/icone_zotero.png) [Documentation Zotero : Ajouter des fichiers à votre bibliothèque Zotero](https://www.zotero.org/support/fr/attaching_files)

![icone_zotero](img/icone_zotero.png) [Documentation Zotero : Récupérer les métadonnées des PDF](https://www.zotero.org/support/fr/retrieve_pdf_metadata)
...
![icone_zotero](img/icone_zotero.png) [Documentation Zotero : Tri](https://www.zotero.org/support/fr/sorting)

![icone_zotero](img/icone_zotero.png) [Documentation Zotero : Notes](https://www.zotero.org/support/fr/notes)

![icone_zotero](img/icone_zotero.png) [Documentation Zotero : Documents connexes](https://www.zotero.org/support/fr/related)
...
![icone_zotero](img/icone_zotero.png) [Documentation Zotero : Les styles bibliographiques](https://www.zotero.org/support/fr/styles)
...
![icone_zotero](img/icone_zotero.png) [Documentation Zotero : Créer des bibliographies](https://www.zotero.org/support/fr/creating_bibliographies)
...
Support de formation Urfist Bordeaux : [Partager sa biblio avec Zotero](https://github.com/fflamerie/zotero_collaborative)
...
Cela vous permettra de générer la page de Babord+ d'un document à partir de votre bibliothèque Zotero. Cette page Babord+ affiche toutes les options d'accès disponibles dans votre établissement, et vous pourrez ainsi trouver des PDF que Zotero ne sera pas parvenu à télécharger automatiquement.
...
Le menu "Localiser" donne également accès à des moteurs de recherche intégrés à Zotero.

Vous trouverez des informations détaillées concernant cette fonctionnalité ainsi que **des fichiers configurés prêts à l'emploi** dans la billet du blog Zotero francophone [Les moteurs de recherche intégrés à Zotero](https://zotero.hypotheses.org/3388).
